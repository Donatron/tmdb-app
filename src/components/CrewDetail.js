...
class CrewDetail extends Component {
  componentDidMount() {
      ...
      return (
        <div className="">
          ...
          <div className="container">
            <div className="row">
              <div className="CrewDetail-details col col-md-10 col-lg-8 m-auto">
                <article className="">
                  <div className="CrewDetail-header-image">
                    <Link to="/">
                ...
                <hr />
                <div className="CrewDetail-biography">
                  <h2>Biography</h2>
                  <p>{biography}</p>
                </div>
                <hr />
                <div className="CrewDetail-links">
                  <h2>Links</h2>
                  <div className="links">
                    <a
